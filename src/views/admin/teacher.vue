            ...
            <el-dialog :title="dialogVisibleTitle" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
                ...
                <el-form :model="addRuleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="头像" prop="photo">
                        <el-input v-model="addRuleForm.photo"></el-input>
                    </el-form-item>
                </el-form>
                <!-- 按钮事件 -->
...
<script>
import { getTeacherData, saveOrUpdateGrade, removeByIdOne, removeByIds } from "@/network/admin/teacher";
        ...
        return {
            ...
            rules: {
                username: [
                    ...
                    { min: 3, max: 5, message: '年级名称不能少于3位', trigger: 'blur' }
                ],
                sex: [
                ...
                photo: [
                    ...
                    { min: 2, max: 200, message: '请选择头像', trigger: 'blur' }
                ]
            },
            // 选中的多个要删除的 ids
            multipleSelection: []
